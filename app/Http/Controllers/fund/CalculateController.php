...
class CalculateController extends Controller {
    ...
    public function getIndex() {
        ...
        return view('template.calculate');
    }
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'salary_up' => 'required|max:2',
            'salary_per_month' => 'required|max:2',
            'bonus_per_salary' => 'required|max:2',
            'salary_per_salary' => 'required|max:2',
            'purpose_per_year' => 'required|max:2',
            'age' => 'required|max:2',
    ...
    public function getCalculate(Request $request) {
        ...
        return view("template.calculateresult", $data, array("salary_month_up" => $salary_month_up, "salary_sum" => $salary_sum, "bonus_sum" => $bonus_sum,
